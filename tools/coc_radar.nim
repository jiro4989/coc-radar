...
proc toPc*(this: SrcPc, url: string): Pc =
  ...
  block:
    var data: Ability
    data.str = CValue(name: "STR", num: this.NP1.parseInt)
    data.con = CValue(name: "CON", num: this.NP2.parseInt)
    data.pow = CValue(name: "POW", num: this.NP3.parseInt)
    data.dex = CValue(name: "DEX", num: this.NP4.parseInt)
    data.app = CValue(name: "APP", num: this.NP5.parseInt)
    data.siz = CValue(name: "SIZ", num: this.NP6.parseInt)
    data.int2 = CValue(name: "INT", num: this.NP7.parseInt)
    data.edu = CValue(name: "EDU", num: this.NP8.parseInt)
    data.hp = CValue(name: "HP", num: this.NP9.parseInt)
    data.mp = CValue(name: "MP", num: this.NP10.parseInt)
    data.initSan = CValue(name: "初期SAN", num: this.NP11.parseInt)
    data.idea = CValue(name: "アイデア", num: this.NP12.parseInt)
    data.luk = CValue(name: "幸運", num: this.NP13.parseInt)
    data.knowledge = CValue(name: "知識", num: this.NP14.parseInt)
